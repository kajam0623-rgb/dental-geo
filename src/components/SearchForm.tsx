...
export default function SearchForm({ onNext, isLoading = false }: SearchFormProps) {
  ...
  const inputCls = "w-full px-4 py-3.5 rounded-xl border border-slate-700 bg-slate-800/50 text-white focus:outline-none focus:ring-2 focus:ring-[#006400] transition placeholder:text-slate-500 disabled:opacity-50 text-sm";
